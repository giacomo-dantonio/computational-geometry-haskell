...
/* package computational-geometry-haskell-0.1.0.0 */
#define VERSION_computational_geometry_haskell "0.1.0.0"
#define MIN_VERSION_computational_geometry_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "computational-geometry-haskell-0.1.0.0"

#define CURRENT_PACKAGE_KEY "computational-geometry-haskell-0.1.0.0"
